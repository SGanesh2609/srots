...
//	@Autowired
//	private FileService fileService; // Injected FileService
//
...
//		}
//		// Duplicate checks
//		if (collegeRepo.existsByEmail(dto.getEmail())
//				&& (id == null || !collegeRepo.findById(id).get().getEmail().equals(dto.getEmail()))) {
//			throw new BadRequestException("Email already exists.");
//		}
//		if (collegeRepo.existsByPhone(dto.getPhone())
//				&& (id == null || !collegeRepo.findById(id).get().getPhone().equals(dto.getPhone()))) {
//			throw new BadRequestException("Phone already exists.");
//		}
//		if (dto.getLandline() != null && collegeRepo.existsByLandline(dto.getLandline())
//				&& (id == null || !collegeRepo.findById(id).get().getLandline().equals(dto.getLandline()))) {
...
//	}
//
//	// Other methods remain unchanged, but add logger where needed
//
...
//		try {
//			if (dto.getAboutSections() == null || entity.getAboutSections() == null)
//				return;
//
//			List<Map<String, Object>> newSections = mapper.convertValue(dto.getAboutSections(), new TypeReference<>() {
//			});
//			List<String> newUrls = newSections.stream().map(s -> (String) s.get("imageUrl")).filter(Objects::nonNull)
//					.toList();
//
...
//				// If old URL is not in the new list, it was removed by user, so delete from
//				// storage
...
//			}
//			res.setSocialMedia(
//					entity.getSocialMedia() != null ? mapper.readValue(entity.getSocialMedia(), Map.class) : null);
...
//
//	@Override
//	public List<CollegeResponse> getColleges(String q) {
//		return collegeRepo.searchColleges(q).stream().map(this::convertToResponse).toList();
//	}
//
//	@Override
//	public CollegeResponse getCollegeById(String id) {
//		return convertToResponse(
//				collegeRepo.findById(id).orElseThrow(() -> new RuntimeException("College not found with ID: " + id)));
//	}
//
//	@Override
//	public List<Object> getBranchesByCollegeId(String id) {
//		College c = collegeRepo.findById(id).orElseThrow(() -> new RuntimeException("College not found"));
//		return parseJsonList(c.getBranches());
//	}
//
//	@Override
...
//		College c = collegeRepo.findById(id).orElseThrow(() -> new RuntimeException("College not found"));
//		try {
//			return mapper.readValue(c.getSocialMedia(), Map.class);
//		} catch (Exception e) {
//			return null;
//		}
//	}
...
//		College c = collegeRepo.findById(id).orElseThrow(() -> new RuntimeException("College not found"));
//		return parseJsonList(c.getAboutSections());
//	}
//
//	private List<Object> parseJsonList(String json) {
//		try {
//			return json != null ? mapper.readValue(json, new TypeReference<List<Object>>() {
//			}) : new ArrayList<>();
//		} catch (Exception e) {
...
//		college.setUpdatedAt(LocalDateTime.now());
//		collegeRepo.save(college);
//		if (oldImage != null && !oldImage.equals(dto.getImage()))
...
//			fileService.deleteFile(toDelete.getImage());
...
//			return convertToResponse(collegeRepo.save(college));
//		} catch (Exception e) {
//			throw new RuntimeException("Add branch failed");
//		}
//	}
//
//	@Override
...
//			return convertToResponse(collegeRepo.save(college));
//		} catch (Exception e) {
//			throw new RuntimeException("Update branch failed");
//		}
//	}
//
//	@Override
...
//			return convertToResponse(collegeRepo.save(college));
//		} catch (Exception e) {
//			throw new RuntimeException("Delete branch failed");
//		}
//	}
//
//	private List<BranchDTO> parseBranches(String json) {
//		try {
//			return json != null ? mapper.readValue(json, new TypeReference<List<BranchDTO>>() {
//			}) : new ArrayList<>();
//		} catch (Exception e) {
//			return new ArrayList<>();
//		}
