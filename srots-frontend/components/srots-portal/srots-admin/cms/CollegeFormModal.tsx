...
//             const file = e.target.files[0];
//             setLogoFile(file);
//             setLogoPreview(URL.createObjectURL(file)); // Local preview
//         }
//     };
...
//                     logoUrl: initialData.logoUrl
//                 });
//                 // Fix: Load full address from address_json if available
//                 if (initialData.address_json) {
//                     setAddressForm(initialData.address_json as AddressFormData);
//                 } else {
//                     setAddressForm({
//                         addressLine1: initialData.address || '', 
//                         addressLine2: '', village: '', mandal: '', city: '', state: '', zip: '', country: 'India'
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            if (initialData) {
                ...
                // Load full address from addressDetails if available
