...
// // src/components/colleges/cp-portal/CPUserPortal.tsx
// import React, { useState, useEffect } from 'react';
// import { AnalyticsService, AnalyticsOverviewResponse } from '../../services/analyticsService'; // Assuming path
// import { User, Role } from '../../types'; // DashboardMetrics removed, use AnalyticsOverviewResponse
...
// export const CPUserPortal: React.FC<CPUserPortalProps> = ({ view, user, onUpdateUser }) => {
//   const [metrics, setMetrics] = useState<AnalyticsOverviewResponse | null>(null);
...
//           setMetrics({
//             stats: { totalStudents: 0, placedStudents: 0, placementRate: 0, companiesVisited: 0 },
//             branchDistribution: [],
//             placementProgress: [],
//             jobTypes: [],
//             recentJobs: [],
